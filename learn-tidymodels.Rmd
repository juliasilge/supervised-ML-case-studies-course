...
The two types of models we'll train in this course are **regression** and **classification**. Think of regression models as predicting numeric, continuous quantities and classification models as predicting discrete quantities or class membership or labels.
...
To keep going in your machine learning journey, check out the resources at <https://www.tidymodels.org/>. This site is a central location for resources and documentation for tidymodels packages, and there is a ton to explore and learn. 🚀
